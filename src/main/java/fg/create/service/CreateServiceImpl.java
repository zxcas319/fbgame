...
public class CreateServiceImpl implements CreateService{
	...
	public List<Map<String, Object>> getPlayerList(String key) throws Exception {
		// TODO Auto-generated method stub
		return createDAO.getPlayerList(key);
	}
	...
	public List<Map<String, Object>> getPlayerOverall(List<Map<String, Object>> list) throws Exception {
		...
		for(int i = 0;i < list.size();i++) {
			...
			overall_fw[0] = createDAO.getPlayerOverall("0_FW", key).get("average");
			overall_fw[1] = createDAO.getPlayerOverall("1_FW", key).get("average");
			overall_mf[0] = createDAO.getPlayerOverall("0_MF", key).get("average");
			overall_mf[1] = createDAO.getPlayerOverall("1_MF", key).get("average");
			overall_mf[2] = createDAO.getPlayerOverall("2_MF", key).get("average");
			overall_mf[3] = createDAO.getPlayerOverall("3_MF", key).get("average");
			overall_df[0] = createDAO.getPlayerOverall("0_DF", key).get("average");
			overall_df[1] = createDAO.getPlayerOverall("1_DF", key).get("average");
			overall_gk[0] = createDAO.getPlayerOverall("0_GK", key).get("average");
	...
	public void removePlayerList(String key) throws Exception {
		// TODO Auto-generated method stub
		createDAO.removePlayerList(key);
	}
	...
	@Override
	public UserVO getUserInfo(String key) throws Exception {
		// TODO Auto-generated method stub
		return createDAO.getUserInfo(key);
	}
}