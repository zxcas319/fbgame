...
function start() {
	inter = setInterval(function() {
		time--;
		if(timecheck == 0){
			$("#detail_info").html("<p style='font-size:200%; text-align:center;'>경기 시작까지 남은 시간</p><p style='font-size:300%; text-align:center;'>" + parseInt(time / 100) +"</p>");
		}
		if(time / 100 == 0){
					...
					<!-- content start -->
						...
						<td class='content_300'>
							<table class='position_setting' id='my_position'>
								...
								<tr>
									<td colspan='5' style='width: 300px;' data-position='GK'></td>
								</tr>
								<tr>
